#mc8
scoreboard players set none wandcalc -1
scoreboard players set one wandcalc 1
...
execute as @a[scores={wand=1..}] run tellraw @s [{"text":"Left click: select pos #1; Right click: select pos #2","color":"light_purple"}]
